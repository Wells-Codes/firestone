...
import { ActiveSubscriptionPlan } from './models/active-subscription-plan';
...
export class OverwolfService {
	...
	public async hideCollectionWindow(prefs: any): Promise<void> {
	...
	private twitterUserInfo: any = null;
	...
	public async getTwitterUserInfo(forceRefresh = false): Promise<any> {
	...
	private redditUserInfo: any = null;
	...
	public async getRedditUserInfo(forceRefresh = false): Promise<any> {
