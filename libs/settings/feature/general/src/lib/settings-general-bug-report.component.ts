...
import { LogsUploaderService } from '@core/src/js/services/logs-uploader.service';
import { OverwolfService } from '@core/services/overwolf.service';
import { PreferencesService } from '@core/services/preferences.service';

const FEEDBACK_ENDPOINT_POST =
  'https://91hyr33pw4.execute-api.us-west-2.amazonaws.com/Prod/feedback';
  ...
  async submit() {
    ...
    try {
      ...
      const submission = {
        ...
        message: this.body,
        user: currentUser
          ? currentUser.username || currentUser.userId || currentUser.machineId
          : undefined,
        appLogsKey: appLogs,
